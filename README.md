...
**Экспериментальная версия 0.2.6.** [Скачать DMG](https://github.com/cypresskir/Liduo/releases/download/v0.2.6/Liduo-v0.2.6-macos-arm64.dmg)
или открыть [страницу выпуска](https://github.com/cypresskir/Liduo/releases/tag/v0.2.6).
...
В версии 0.2.6 установка не требует Терминала, Homebrew, Node.js или Xcode:

1. Откройте `Liduo-v0.2.6-macos-arm64.dmg` и перетащите Liduo в «Программы».
